...
public class Game {
 ...
 // methed to run the sound
    public static Runnable  playSound() {
        Thread runnablePlay = new Thread() {
            @Override
            public void run() {
                try {

                    File file = new File("sound/bird_sound.mp3");
                    String absolute = file.getAbsolutePath();
                    FileInputStream fileInputStream = new FileInputStream(absolute);
                   BufferedInputStream bufferedInputStream = new BufferedInputStream(fileInputStream);
                     audioPlayer = new Player(new BufferedInputStream(bufferedInputStream));
